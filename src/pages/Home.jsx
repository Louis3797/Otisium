...
import { IoLogoInstagram, IoLogoFacebook, IoLogoYoutube, IoIosArrowDown} from "react-icons/io";

import "../css/Home.css";
import Bg from "../assets/images/otisium-bg-2.jpg"
...
export const Home = () => {
    ...
    return(
        <>
            ...
            <img src={Bg} alt=""/>
            <p className="home-title">"Stärke wächst nicht aus körperlicher Kraft - vielmehr aus unbeugsamen
          Willen"</p>
